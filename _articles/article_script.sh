...
# Check if a file name was provided. It needs to be wrapped in quotes
if [ -z "$1" ]
  then
...
echo "description": "A brief description of my Jekyll blog post for the meta description." >> "$filename"
echo "---" >> "$filename"
